...
if (window.location.pathname == "/Portfolio/competence.html") {
    ...
    button.addEventListener("click", function() {
        ...
        if (projectTitle.innerHTML == "PYTHON") {
            ...
            thirdP.innerHTML = "Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter. Pour MYSQL je sais comment séléctionné, insérer, supprimer ou modifier des choses dans la base de données. Grace à ces deux languages j'ai créer une version simplifier de twitter."
